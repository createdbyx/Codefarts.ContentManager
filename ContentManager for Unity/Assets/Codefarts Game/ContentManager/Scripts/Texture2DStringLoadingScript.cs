...
namespace Codefarts.ContentManager.Scripts
{
    ...
    /// </summary>
    public class Texture2DStringLoadingScript : MonoBehaviour
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Texture2DStringLoadingScript"/> class.
        /// </summary>
        public Texture2DStringLoadingScript()
        {
        ...
        public void Start()
        {
            ...
            // register readers
            this.manager.Register(new Texture2DStringReader());
